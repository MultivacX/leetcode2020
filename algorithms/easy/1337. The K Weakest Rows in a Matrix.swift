...
// Runtime: 80 ms, faster than 100.00% of Swift online submissions for The K Weakest Rows in a Matrix.
// Memory Usage: 14.3 MB, less than 95.24% of Swift online submissions for The K Weakest Rows in a Matrix.

class Solution {
    func kWeakestRows(_ mat: [[Int]], _ k: Int) -> [Int] {
        var q = PriorityQueue<Pair>(sort: >)
        for i in 0..<mat.count {
            var p = Pair(idx: i, val: 0) 
...
private func > (m1: Pair, m2: Pair) -> Bool {
  return m1.val > m2.val || (m1.val == m2.val && m1.idx > m2.idx)
}
